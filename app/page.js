...
function HeaderLogo(){
  return (
    <div style={{display:'flex', alignItems:'center', gap:10}}>
      <img src="https://raw.githubusercontent.com/terrotkone/K-1ome-fix/main/IMG-20260920-WA1043.jpg" style={{width:52, height:52, borderRadius:'50%', objectFit:'cover', background:'#fff', border:'2px solid #000'}} alt="K-ONE" />
      <div>
